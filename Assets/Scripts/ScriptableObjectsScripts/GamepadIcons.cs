    ...
    public class GamepadIcons : ScriptableObject
    {
        ...
        public static GamepadIcons I
        {
            get
            {
                if (i == null)
                {
                    i = Resources.Load<GamepadIcons>("GamepadIcons");
                }
        ...
        {
            bool isPS = IsPlayStation(Gamepad.current);
        ...
        private static bool IsPlayStation(Gamepad gp)
        {
            ...
            string name = (gp.displayName ?? gp.name ?? "").ToLower();
            return name.Contains("dual") || name.Contains("playstation") || name.Contains("ps5") || name.Contains("ps4");
        }
    }
}
